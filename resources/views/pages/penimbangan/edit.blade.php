        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    ...
                    <form action="{{ route('penimbangan.update', $penimbangans->id_penimbangan) }}" method="POST">
                        <div class="card-body">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                @error('berat_badan') is-invalid @enderror"
                                    value="{{ old('berat_badan', $penimbangans->berat_badan) }}">
                            </div>
                            <div class="form-group">
                                ...
                                @error('tinggi_badan') is-invalid @enderror"
                                    value="{{ old('tinggi_badan', $penimbangans->tinggi_badan) }}">
                            </div>
                            <div class="form-group">
                                <label>Tanggal</label>
                                ...
                                value="{{ old('tanggal', $penimbangans->tanggal) }}">
                            </div>
                        </div>
